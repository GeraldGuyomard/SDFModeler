...
- (void)loadWorld
{
    ...
    negativeSpherePart->setOperation(SimpleGeometryObject3D::Operation::substraction);
    ...
    negativeRoundedBoxPart->setOperation(SimpleGeometryObject3D::Operation::substraction);
